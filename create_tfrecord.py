...
def create_example(xml_file):
        ...
        for member in root.findall('object'):
           ...
           xmin.append(float(member[5][0].text) / width)
           ymin.append(float(member[5][1].text) / height)
           xmax.append(float(member[5][2].text) / width)
           ymax.append(float(member[5][3].text) / height)
